...
// node_modules/@web3auth/base/node_modules/@toruslabs/openlogin-utils/dist/openloginUtils.esm.js
...
var Web3AuthError = class extends CustomError {
  ...
  toJSON() {
    return {
      ...
      code: this.code,
      message: this.message,
      cause: serializeError2([this.cause])
    };
  }
  toString() {
...
var getChainConfig = (chainNamespace, chainId) => {
...
var WEB3AUTH_NETWORK = OPENLOGIN_NETWORK;
...
var fetchProjectConfig = async (clientId, web3AuthNetwork) => {
...
var loglevel = import_loglevel2.default.getLogger("web3auth-logger");
...
*/
//# sourceMappingURL=chunk-ZKTYXTKV.js.map
