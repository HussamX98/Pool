  ...
  return (0, import_jsx_runtime.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [(0, import_jsx_runtime.jsx)("input", {
        ...
        children: t2("modal.errors-invalid-number-email")
  ...
  constructor(_uiConfig) {
    ...
    _defineProperty(this, "initModal", async () => {
      ...
      if (useLang === LANGUAGES.de) {
        import("./german-Cosm3DTT-HHNHV53L.js").then((messages) => {
        ...
        import("./japanese-CxepACv7-GZDEJOHM.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./korean-B9gddtda-3PUKXAFZ.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./mandarin-BLpDG3ey-F3GXFMKN.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./spanish-DcKAGK9t-U3BNBWTP.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./french-Dzf45OF_-KW3XBD66.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./portuguese-D2BajECg-47H6KB6Z.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./dutch-C_uXCtFc-O4KL2TLM.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
        ...
        import("./turkish-eayLYBl3-BOBZBCEF.js").then((messages) => {
          i18nInstance2.addResourceBundle(useLang, "translation", messages.default);
          return i18nInstance2.changeLanguage(useLang);
        }).catch((error) => {
          loglevel.error(error);
...
function Web3AuthInnerProvider(params) {
  ...
  }, [web3Auth, isConnected, isInitialized, provider, userInfo, isMFAEnabled, status, getPlugin, initModal, connect, enableMFA, logout, addAndSwitchChain, addChain, addPlugin, authenticateUser, switchChain]);
