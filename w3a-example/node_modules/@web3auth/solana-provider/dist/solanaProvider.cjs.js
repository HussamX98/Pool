...
const isVersionTransction = transaction => transaction.version !== undefined || transaction instanceof web3_js_namespaceObject.VersionedTransaction;
const getSlopeHandlers = (injectedProvider, getProviderEngineProxy) => {
  const providerHandlers = {
    ...
    signTransaction: async req => {
      ...
      if (!txMessage) throw openlogin_jrpc_namespaceObject.rpcErrors.invalidRequest({
